...
public class AddDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.insert_task_dialog_view);
        //按空白处不能取消动画
        ...
        positiveBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ( onClickBottomListener!= null) {
                    onClickBottomListener.onPositiveClick(edtName.getText().toString(),edtMsg.getText().toString());
                }
            }
        });
        //设置取消按钮被点击后，向外界提供监听
    ...
    private void initView() {
        ...
        edtName = (EditText) findViewById(R.id.task_name);
        edtMsg = (EditText) findViewById(R.id.task_message);
